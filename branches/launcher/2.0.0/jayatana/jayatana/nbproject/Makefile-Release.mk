...
${OBJECTDIR}/ayatana_JVM.o: ayatana_JVM.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux `pkg-config --cflags glib-2.0 gio-2.0 dbusmenu-glib-0.4 xt unity`    -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ayatana_JVM.o ayatana_JVM.c

${OBJECTDIR}/ayatana_Collections.o: ayatana_Collections.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux `pkg-config --cflags glib-2.0 gio-2.0 dbusmenu-glib-0.4 xt unity`    -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ayatana_Collections.o ayatana_Collections.c

${OBJECTDIR}/ayatana_JKeyToXKey.o: ayatana_JKeyToXKey.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Wall -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux `pkg-config --cflags glib-2.0 gio-2.0 dbusmenu-glib-0.4 xt unity`    -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ayatana_JKeyToXKey.o ayatana_JKeyToXKey.c
